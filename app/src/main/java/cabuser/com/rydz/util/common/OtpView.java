...
/**
 * Created by priyanka on 22/3/18.
 */

public class OtpView extends LinearLayout {
    public EditText mOtpOneField, mOtpTwoField, mOtpThreeField, mOtpFourField,
    ...
    private void init(AttributeSet attrs) {
        ...
        mInflater.inflate(R.layout.layout_otpview, this);
    ...
    private void setEditTextInputStyle(TypedArray styles) {
       ...
       // setDeleteKey(mOtpOneField);
        setDeleteKey(mOtpTwoField);
        setDeleteKey(mOtpThreeField);
        setDeleteKey(mOtpFourField);
    ...
    private void setOnTextChangeListener() {
        TextWatcher textWatcher = new TextWatcher() {
            @Override public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (mCurrentlyFocusedEditText.getText().toString().trim().length() == 0) {
                    Log.e("225","225");
                ...
                try {
                    if (mCurrentlyFocusedEditText.getText().length() >= 1
                        ...
                        if (imm != null) {
                            ...
                            try {
                                // VerifyOtpActivity.resendTimer.cancel();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
    ...
    public void setDeleteKey(final EditText editText)
    {
